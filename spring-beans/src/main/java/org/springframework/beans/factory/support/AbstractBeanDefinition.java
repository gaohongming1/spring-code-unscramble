...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
	...
	//设置属性值存放
	private final Map<String, org.springframework.beans.factory.support.AutowireCandidateQualifier> qualifiers =
			new LinkedHashMap<String, org.springframework.beans.factory.support.AutowireCandidateQualifier>(0);
	...
	//存储杯IOC容器覆盖掉的方法的相关信息
	private org.springframework.beans.factory.support.MethodOverrides methodOverrides = new org.springframework.beans.factory.support.MethodOverrides();
	 ...
	 * 使用构造函数 和属性初始化 beanDefinition
	 * MutablePropertyValues 使用参考 https://blog.csdn.net/weixin_30525825/article/details/101421022
	 * ConstructorArgumentValues 使用参考 https://blog.csdn.net/QIANQIANCHEN0/article/details/81154341
	 */
	...
	protected AbstractBeanDefinition(BeanDefinition original) {
		...
		if (original instanceof AbstractBeanDefinition) {
			...
			setMethodOverrides(new org.springframework.beans.factory.support.MethodOverrides(originalAbd.getMethodOverrides()));
	 ...
	 * </ul>
	 * 从另一个BeanDefinition中覆盖 或者是从父对象中赋值
	 */
	 ...
	 * 设置默认值
	 */
	public void applyDefaults(org.springframework.beans.factory.support.BeanDefinitionDefaults defaults) {
	...
	public Class<?> resolveBeanClass(ClassLoader classLoader) throws ClassNotFoundException {
		...
		//通过反射机制根据类名加载类 使用参考 https://blog.csdn.net/qq_21399231/article/details/80751489
	 ...
	 */
	public void addQualifier(org.springframework.beans.factory.support.AutowireCandidateQualifier qualifier) {
	 ...
	 */
	public org.springframework.beans.factory.support.AutowireCandidateQualifier getQualifier(String typeName) {
	 ...
	 */
	public Set<org.springframework.beans.factory.support.AutowireCandidateQualifier> getQualifiers() {
		return new LinkedHashSet<org.springframework.beans.factory.support.AutowireCandidateQualifier>(this.qualifiers.values());
	}
	 ...
	 */
	public void setMethodOverrides(org.springframework.beans.factory.support.MethodOverrides methodOverrides) {
		this.methodOverrides = (methodOverrides != null ? methodOverrides : new org.springframework.beans.factory.support.MethodOverrides());
	}
	...
	public void setOriginatingBeanDefinition(BeanDefinition originatingBd) {
		this.resource = new org.springframework.beans.factory.support.BeanDefinitionResource(originatingBd);
	}

	@Override
	public BeanDefinition getOriginatingBeanDefinition() {
		return (this.resource instanceof org.springframework.beans.factory.support.BeanDefinitionResource ?
				((org.springframework.beans.factory.support.BeanDefinitionResource) this.resource).getBeanDefinition() : null);
	}
	...
	public void validate() throws org.springframework.beans.factory.support.BeanDefinitionValidationException {
		if (!getMethodOverrides().isEmpty() && getFactoryMethodName() != null) {
			throw new org.springframework.beans.factory.support.BeanDefinitionValidationException(
	...
	public void prepareMethodOverrides() throws org.springframework.beans.factory.support.BeanDefinitionValidationException {
		...
		org.springframework.beans.factory.support.MethodOverrides methodOverrides = getMethodOverrides();
		if (!methodOverrides.isEmpty()) {
			for (org.springframework.beans.factory.support.MethodOverride mo : methodOverrides.getOverrides()) {
	 ...
	 * @throws BeanDefinitionValidationException in case of validation failure
	 */
	protected void prepareMethodOverride(org.springframework.beans.factory.support.MethodOverride mo) throws org.springframework.beans.factory.support.BeanDefinitionValidationException {
