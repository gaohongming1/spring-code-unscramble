...
/**
 * 需要实现自动装配并且自动装配需要暴露给外部应用的实现这个接口
 */
public interface AutowireCapableBeanFactory extends BeanFactory {
	 ...
	 */
	Object resolveDependency(org.springframework.beans.factory.config.DependencyDescriptor descriptor, String beanName) throws BeansException;
	 ...
	 * @throws BeansException in dependency resolution failed
	 */
	Object resolveDependency(org.springframework.beans.factory.config.DependencyDescriptor descriptor, String beanName,
