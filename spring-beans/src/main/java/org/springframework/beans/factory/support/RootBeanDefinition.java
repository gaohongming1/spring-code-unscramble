...
public class RootBeanDefinition extends org.springframework.beans.fatory.support.AbstractBeanDefinition {
	//当前bean是否允许缓存 也就是每次创建bean实例的时候是否都重新创建beanDefinition 重而实现热加载
	boolean allowCaching = true;

	//beanDefinition的持有 包含具体的beanDefinition和别名
