...
public interface BeanFactory {
	 ...
	 */
	/**
	 * bean 容器区别是普通bean还是 工厂bean
	 * factoryBean的使用  https://blog.csdn.net/clxjoseph/article/details/85682253
	 * 获取工厂本身则需要 加上 &bean限定符   来获得工厂bean，否则则是获取的工厂产生的bean
	 */
	 ...
	 * @see #getBean
	 * @see #isSingleton
	 * todo 判断是不是原型模式，每次创建或者重新注入都会返回一个新的对象
	 */
	 ...
	 *
	 */
	boolean isTypeMatch(String name, Class<?> targetType) throws org.springframework.beans.factory.NoSuchBeanDefinitionException;
	 ...
	 * @see #getBean
	 * @see #isTypeMatch
	 * todo 获得指定名字的bean的class类型
	 */
	Class<?> getType(String name) throws org.springframework.beans.factory.NoSuchBeanDefinitionException;
